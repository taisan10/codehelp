...
const ApproachSection = () => {
  return (
    <section id="approach" className="bg-white text-gray-900 py-10">
      <Container>
        <div className="rounded-3xl bg-gradient-to-r from-sky-500 to-cyan-400  p-6 sm:p-8 ring-1 ring-white/10 w-200">
          <h2 className="text-3xl font-bold mb-4">Approach</h2>
          <p className="text-lg leading-relaxed max-w-3xl text-white">
...
const CuriousSection = () => {
  return (
    <section id="curious-about-our-approach" className="py-12 sm:py-16 bg-white ">
      <Container>
