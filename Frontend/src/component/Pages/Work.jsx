  ...
  return (
    <section ref={sectionRef} id="overview" className="px-6 py-10 bg-gray-50">
      ...
      <p className="text-gray-700 text-lg mb-8 max-w-3xl">
        Triveeni Events is a women-led event planning company specializing in
        creating extraordinary Indian celebrations and cultural events across
        ...
        preserving cultural heritage while creating modern, memorable
        experiences. <br />
        <br />
        ...
        <br />
        We focused on a Reels-first content approach and algorithm optimization
        to maximize reach without heavy ad spend, effectively showcasing
        Triveeni Events' stunning portfolio of colorful celebrations to attract
        high-quality client inquiries and engage enthusiasts across all
        demographics.
      </p>
  ...
  return (
    <section id="challenge" className="px-6 py-10 bg-gray-50">
      ...
      <p className="text-gray-700 text-lg max-w-3xl leading-relaxed">
        ...
        attract quality leads. Key challenges included: Low initial engagement{" "}
        <br />
        <br />
        ...
        <br />
        Requirement to build authentic audience of potential clients and
      ...
      <Container>
        <div className="rounded-3xl bg-gradient-to-r from-sky-500 to-cyan-400 p-6 sm:p-8 ring-1 ring-white/10">
          ...
          <p className="text-lg leading-relaxed max-w-6xl text-black">
            Phase 1: Build awareness through algorithm-optimized content
            strategy. Establish baseline metrics and test various content
            formats to identify top performers. Focus on Reels production
            featuring event highlights, venue transformations, and client
            testimonials with trending audio and viral content elements.
            <br />
            <br />
            Phase 2: Scale successful content formats and double down on Reels
            strategy showcasing Triveeni Events' diverse portfolio. Optimize
            posting times based on audience analytics. Implement advanced
            hashtag research targeting event planning, wedding, and corporate
            event niches. Create Explore page optimization tactics.
            <br />
            <br />
            Phase 3: Maximize reach through refined content calendar featuring
            seasonal events and proven viral formulas. Achieve consistent
            non-follower engagement above 60% to attract new clients. Establish
            sustainable growth model for long-term lead generation and brand
            authority.
          </p>
        </div>
      </Container>
          ...
          <div className="md:w-3/5 rounded-xl overflow-hidden shadow-lg flex flex-col justify-between">
            ...
            >
              ...
              <img
                src={studies[0].img}
                alt={studies[0].title}
                className="w-70 mt-4 rounded-lg object-cover max-h-60"
              />
            </div>
          </div>
          ...
          <div className="md:w-2/5 rounded-xl overflow-hidden shadow-lg flex flex-col justify-between">
            ...
            >
              ...
              <img
                src={studies[1].img}
                alt={studies[1].title}
                className="w-80 mt-4 rounded-lg object-cover max-h-60"
              />
            </div>
          </div>
        </div>
          ...
          <div className="md:w-35% rounded-xl overflow-hidden shadow-lg flex flex-col justify-between">
            ...
            >
              ...
              <img
                src={studies[2].img}
                alt={studies[2].title}
                className="w-90 mt-4 rounded-lg object-cover max-h-60"
              />
            </div>
          </div>
